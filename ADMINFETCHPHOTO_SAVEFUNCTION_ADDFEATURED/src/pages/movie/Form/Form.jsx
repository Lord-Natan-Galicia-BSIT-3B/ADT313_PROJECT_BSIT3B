...
const Form = () => {
  ...
  const saveVideos = async (movieId, videos) => {
    ...
    try {
      const videoPromises = videos.map((video) => {
        ...
        return axios.post("/movieproject-api/admin/videos", videoData, {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
        });
  ...
  <label htmlFor="isFeatured" className="featured-labell"> Featured  </label>
    <input
      type="checkbox"
      name="isFeatured"
      id="isFeatured"
  ...
  <span className="featured-description">
    Check this box if you want this movie to be featured on the homepage.
  </span>
</div>
